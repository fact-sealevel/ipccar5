...
def ar5_preprocess_glaciers(
    ...
    output = {
        "temp_mean": temp_mean,
        "temp_sd": temp_sd,
        "inttemp_mean": inttemp_mean,
        "inttemp_sd": inttemp_sd,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the glaciers pre-processing stage for the AR5 Global SLR projection workflow",
    ...
    parser.add_argument(
        "--scenario", help="Scenario [default='rcp85']", default="rcp85"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--baseyear",
        help="Year from which to start integrating temperature [default=2006]",
        type=int,
        default=2006,
    )
    parser.add_argument(
        "--tlm_data",
        help="Use the two-layer model data [default=1, use 2lm data]",
        default=1,
        type=int,
    )
    parser.add_argument(
