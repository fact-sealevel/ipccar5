...
def ar5_fit_glaciers(start_year, use_gmip, pipeline_id):
    ...
    if use_gmip == 2:
        glparm = [
            dict(name="GLIMB", factor=2.30, exponent=0.753, cvgl=0.209),
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the glaciers fitting stage for the AR5 SLR projection workflow",
    ...
    parser.add_argument(
        "--gmip",
        help="Use the GMIP calibration [default=2]",
        default=2,
        choices=[0, 1, 2],
        type=int,
    )
