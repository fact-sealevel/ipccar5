...
def ar5_fit_icesheets(preprocess_dict, pipeline_id):
    ...
    output = {
        ...
        "KoKg": KoKg,
        "smax": smax,
        "gdyn_finalrange": gdyn_finalrange,
        "adyn_finalrange": adyn_finalrange,
        "adyn_startratemean": adyn_startratemean,
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run the icesheets fitting stage for the AR5 SLR projection workflow",
