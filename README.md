...
This is an application that repicates the `ipccar5/glaciers` sub-module of FACTS 1; it implements the glacier projection approach adopted by IPCC AR5 WG1. It was translated from IDL to Python 2.7 by Jonathan Gregory 23.10.19 and adapted for use in FACTS by Gregory Garner 20 November 2019.
